...
export const editProductByIdPage = {
    after_render: async () => {
      ...
      productForm.addEventListener('submit', (e) => {
          ...
          fetch(url, {
            ...
            .then(response => {
              if (!response.ok) {
                throw new Error('Nincs admin jogosultságod ehhez.')
              }
    ...
    render: async function () {
        ...
        return `
        <div class="flex justify-center text-xl font-bold mb-8">Termék szerkesztése</div>
