...
export const basketballPageEN = {
  render: async function () {
    ...
    let basketballShoes = products.filter(function (product) {
      return product.category === "basketball"
    })
    ...
    if (selectedCurrency === 'HUF') {
        basketballShoes.forEach(product => {
    ...
    return `
      <div> 
        <p class="uppercase text-3xl md:text-4xl p-8 flex justify-center mt-16">Basketball shoes</p> 
      </div>
